...
ApiRoute::group(['namespace' => 'App\Http\Controllers\Api'], function () {
    ApiRoute::get('products/export', [
        'as' => 'api.products.export',
        'middleware' => function ($request, $next) {
            if (!session('user')?->ability('admin', 'products_view')) {
                return response(['error' => ['message' => 'UNAUTHORIZED', 'code' => 403]], 403, [
    ...
    ApiRoute::group(['middleware' => ['api.permission.check', 'api.auth.check', 'license-expire']], function () {
        ...
        ApiRoute::get('sales-summary', ['as' => 'api.sales.summary', 'uses' => 'SalesController@getSummary']);
