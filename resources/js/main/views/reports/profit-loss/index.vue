            ...
            <a-page-header :title="$t(`menu.profit_loss`)" class="p-0">
                <template #extra>
                    <ExprotTable
                        ...
                        :title="`${$t('menu.profit_loss')} ${$t(
                            'menu.reports'
                        )}`"
                    />
                    <ExprotTable
                        v-if="
                            selectedTab == 'by_dates' &&
                            dateWiseReportResults.length > 0
                        "
                        ...
                        >
                            ...
                            <a-descriptions-item>
                                <template #label>
                                    {{
                                        $t(
                                            "stock_transfer.stock_transfer_transfered"
                                        )
                                    }}
                                    (+)
                                </template>
                            ...
                            <a-descriptions-item>
                                <template #label>
                                    {{
                                        $t(
                                            "stock_transfer.stock_transfer_received"
                                        )
                                    }}
                                    (-)
                                </template>
                            ...
                            <a-descriptions-item>
                                ...
                                {{
                                    formatAmountCurrency(
                                        reportData.payment_sent
                                    )
                                }}
                            </a-descriptions-item>
                            <a-descriptions-item
                                :label="$t('common.profit_by_payment')"
                            >
                                <a-typography-text
                                    :type="
                                        reportData.profit_by_payment > 0
                                            ? 'success'
                                            : 'danger'
                                    "
                                    strong
            ...
            <a-tab-pane key="by_dates">
                ...
                >
                    ...
                    >
                        <a-col
                            :span="24"
                            :class="['mt-10', `tbl_result_${resultIndex}`]"
                        >
                            <a-descriptions
...
export default {
    ...
    setup() {
        ...
        const getData = (filterDate) => {
            axiosAdmin
                .post("reports/profit-loss", filterDate)
                .then((response) => {
                    ...
                    var newFinalData = filter(
                        ...
                        (allExportDataNew) =>
                            allExportDataNew.export_type !=
                            "profit_loss_reports_by_dates"
                    );
