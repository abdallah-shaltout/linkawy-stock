                                    ...
                                    >
                                        <tbody class="text-gray-600 fw-bold">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex" style="flex-wrap: wrap; font-size: 12px">
                                                        <label
                                                            class="form-check form-check-custom me-5 me-lg-20"
                                                        >
                                                            <a-checkbox
