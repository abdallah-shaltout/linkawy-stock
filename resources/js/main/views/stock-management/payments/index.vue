    ...
    setup() {
        ...
        const setUrlData = () => {
            crudVariables.tableUrl.value = {
                url: `payment-${paymentType.value}?fields=id,xid,date,amount,notes,payment_mode_id,payment_number,payment_type,payment_mode_id,x_payment_mode_id,paymentMode{id,xid,name},user_id,x_user_id,user{id,xid,name,profile_image,email,phone,address,shipping_address,profile_image_url,user_type}`,
