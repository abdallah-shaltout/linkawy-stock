    ...
    <body>
        ...
        <script>
            window.config = {
                ...
                'brand_sample_file': "{{ asset('images/sample_brands.xlsx') }}",
                'customer_sample_file': "{{ asset('images/sample_customers.xlsx') }}",
                'supplier_sample_file': "{{ asset('images/sample_suppliers.xlsx') }}",
                'staff_member_sample_file': "{{ asset('images/sample_staff_members.xlsx') }}",
                'translatioins_sample_file': "{{ asset('images/sample_translations.xlsx') }}",
                'perPage': 10,
