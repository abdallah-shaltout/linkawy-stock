...
<head>
    ...
    <style>
        @font-face {
            ...
            font-style: normal;
            font-weight: normal;
            src: url('./Cairo-VariableFont_slntwght.ttf') format('truetype');
            unicode-range: U+0600-06FF, U+0750-077F, U+0870-088E, U+0890-0891, U+0898-08E1, U+08E3-08FF, U+200C-200E, U+2010-2011, U+204F, U+2E41, U+FB50-FDFF, U+FE70-FE74, U+FE76-FEFC, U+0100-02AF, U+0304, U+0308, U+0329, U+1E00-1E9F, U+1EF2-1EFF, U+2020, U+20A0-20AB, U+20AD-20CF, U+2113, U+2C60-2C7F, U+A720-A7FF, U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
        }
    ...
    <div class="invoice-box">
                ...
                <td style="margin-left: 100px; padding-left: 30%; padding-bottom: 20px;">
                    <table style="width: 100%">
                        <tr style="text-align: left">
                            <td class="space-10">
                                <span style="font-size: 28px; font-weight: 900; font-family: 'Cairo-Bold', sans-serif;">
                        ...
                        <tr>
                            <table cellpadding="0" cellspacing="0" style="width: 100%">
                                <tr>
                                    <td class="space-3 "
                                        style="font-weight: 500; font-family: 'Cairo-Bold', sans-serif;">
        ...
        <table class="information" cellpadding="4px" cellspacing="0" style="border: 1px solid #a9a9a9;">
            ...
            <tr>
                <td class="pl-15 pt-15 pb-15" style="vertical-align:top;">
                    <span
                        style="font-size: 16px; font-weight: 700; font-family: 'Cairo-Bold', sans-serif;">{{ $company->name }}</span>
                    <br>
                ...
                <td class="pl-15 pt-15 pb-15" style="vertical-align:top;">
                    @if ($order->order_type == 'stock-transfers')
                        <span
                            style="font-size: 16px; font-weight: 700; font-family: 'Cairo-Bold', sans-serif;">{{ $order->warehouse->name }}</span><br />
                    ...
                    @else
                        <span
                            style="font-size: 16px; font-weight: 700; font-family: 'Cairo-Bold', sans-serif;">{{ $order->user->name }}</span><br />
                ...
                <tr>
                    <td>
                        <div class="status-due">
                            <div>
                                <h4 style="font-weight: 900; font-family: 'Cairo-Bold', sans-serif;">
                                    {{ $traslations['payment_status'] }}
                                    : {{ $paymentStatusText }}</h4>

                                <table class="table-four">
                                    <tr>
                                        <td>{{ $traslations['paid_amount'] }}</td>
                                        <td>{{ App\Classes\Common::formatAmountCurrency($company->currency, $order->paid_amount) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{{ $traslations['due_amount'] }}</td>
                                        <td>{{ App\Classes\Common::formatAmountCurrency($company->currency, $order->due_amount) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{{ $traslations['payment_mode'] }}</td>
                                        <td class="paid">
                                ...
                                <tbody>
                                    ...
                                    <tr class="item-four">
                                        <td style="border-bottom: 0px;"><b
                                                style="font-weight: 900; font-family: 'Cairo-Bold', sans-serif;">{{ $traslations['total'] }}</b>
                                        </td>
        ...
        <div class="mt-20">
            <div style="width: 65%; float: left;">
                <p class="mt-20" style="font-weight: 900; font-size: 14px; font-family: 'Cairo-Bold', sans-serif;">
                    {{ $traslations['notes'] }}:
                </p>
                <p>{{ $order->notes }}</p>
            </div>
        ...
        <table cellpadding="4px" cellspacing="0" style="width: 100%">
            <tr>
                <td style="width: 50%; vertical-align:top;">
                    <span
                        style="font-weight: 900; font-family: 'Cairo-Bold', sans-serif;">{{ $traslations['terms_condition'] }}</span>
                    <p>{{ $warehouse->terms_condition }}</p>
                </td>
                <td style="width: 50%; vertical-align:top;">
                    <span style="font-weight: 900; font-family: 'Cairo-Bold', sans-serif;">Bank Details</span>
