	...
	public function array(array $categories)
	{
		DB::transaction(function () use ($categories) {
			foreach ($categories as $category) {
				...
				if (
					!array_key_exists('name', $category) || !array_key_exists('parent_category', $category) || !array_key_exists('unit_price', $category)
				) {
