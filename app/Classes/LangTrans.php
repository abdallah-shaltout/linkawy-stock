...
class LangTrans
{
    public static $mainTranslations = [
        'common' => [
            ...
            'amount' => 'Amount',
            'profit' => 'Profit',
            'profit_by_payment' => 'Profit By Payment',
            ...
            'add_invoice_discount' => 'Add Invoice Discount',
        ],
        'menu' => [
            'dashboard' => 'Dashboard',
        ...
        'category' => [
            ...
            'category' => 'Category',
            'enable_unit_price' => 'Enable Unit Price',
            'unit_price_message' => 'Price for products under this category will be automatically calculated based on the category price',
            'name' => 'Name',
            'slug' => 'Slug',
            'logo' => 'Category Logo',
        ...
        'product' => [
            ...
            'barcode_includes' => 'Barcode Includes',
            'barcode' => 'Barcode',
        ...
        'messages' => [
            ...
            'click_here_to_download_sample_file' => 'Click here to download sample xlsx file',
